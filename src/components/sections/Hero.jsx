    ...
    return forgeSparks.map((s, i) => (
      <div 
        ...
        style={{
          ...
          width: `${s.size}px`,
          height: `${s.size}px`,
          backgroundColor: s.isGold ? 'var(--color-gold-light)' : 'var(--color-fire)',
  ...
  return (
    <section className="relative min-h-[100svh] w-full flex flex-col justify-center items-center overflow-hidden bg-transparent">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden perspective-1000">
        ...
        {/* 🐉 CABEÇA */}
        <div 
          className="absolute bottom-[2%] left-[-15%] sm:left-[-10%] md:left-[-5%] w-[85vw] sm:w-[60vw] md:w-[50vw] max-w-[800px] z-30 opacity-100 animate-[forge-reveal_1.5s_ease-out_forwards] transform-gpu"
          style={{ 
      ...
      >
        <div className="absolute inset-0 bg-black/40 blur-[50px] rounded-full z-[-1] will-change-[transform,opacity] transform-gpu"></div>
        ...
        <div className="space-y-4 animate-[forge-reveal_1.5s_ease-out_forwards] px-4 transform-gpu">
          {/* Adicionado 'text-balance' e o '&nbsp;' entre as palavras 'de' e 'ponta' */}
          <p className="text-zinc-300 text-xs sm:text-sm md:text-lg max-w-2xl leading-relaxed font-sans font-light tracking-wide mx-auto text-balance">
            A primeira experiência imersiva de fantasia sombria movida por tecnologia de&nbsp;ponta.
          </p>
          <p className="text-white font-medieval tracking-[0.25em] text-xs sm:text-sm md:text-lg drop-shadow-[0_2px_8px_rgba(0,0,0,1)] uppercase">
            Sobreviva <span className="text-zinc-500 mx-2 sm:mx-3">|</span> Proteja <span className="text-zinc-500 mx-2 sm:mx-3">|</span> Reconstrua
          </p>
        </div>
