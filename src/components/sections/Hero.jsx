  ...
  return (
    <section className="relative min-h-[100svh] w-full flex flex-col justify-center items-center overflow-hidden bg-transparent">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden perspective-1000">
        ...
        {/* 🐉 PESCOÇO - Ajuste Mobile: Sumir no celular horizontal (landscape:hidden), mas voltar no desktop (md:landscape:block) */}
        <div
          className="absolute top-[-4%] right-[-18%] md:right-[-10%] w-[75vw] md:w-[40vw] max-w-[700px] z-10 opacity-75 animate-[forge-reveal_1.8s_ease-out_forwards] hidden sm:block landscape:hidden md:landscape:block transform-gpu"
          style={{
        ...
        {/* 🐉 CAUDA - Ajuste Mobile: Sumir no celular horizontal (landscape:hidden), mas voltar no desktop (md:landscape:block) */}
        <div
          className="absolute bottom-[-4%] right-[-4%] md:right-[-2%] w-[70vw] md:w-[38vw] max-w-[600px] z-20 opacity-90 animate-[forge-reveal_2s_ease-out_forwards] hidden sm:block landscape:hidden md:landscape:block transform-gpu"
          style={{
        ...
        {/* 🐉 CABEÇA - Ajuste Mobile: Mais transparente no celular horizontal e com limite de altura, protegido no desktop (md:...) */}
        <div
          className="absolute bottom-[2%] left-[-15%] sm:left-[-10%] md:left-[-5%] w-[85vw] sm:w-[60vw] md:w-[50vw] max-w-[780px] z-30 opacity-40 landscape:opacity-15 md:opacity-100 md:landscape:opacity-100 animate-[forge-reveal_1.5s_ease-out_forwards] transform-gpu"
          style={{
        ...
        >
          <img
            ...
            decoding="async"
            draggable="false"
            className="w-full h-auto object-contain animate-dragon transform-gpu landscape:max-h-[60vh] md:landscape:max-h-none"
            style={{ backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden" }}
          />
        </div>
      </div>
      ...
      {/* =========================================
          4. BLOCO CENTRAL 
          ========================================= */}
      {/* Ajuste Mobile: Menos padding-bottom apenas no celular horizontal (landscape:pb-4), mantendo md:pb-32 intacto pro Desktop */}
      <div
        className="relative z-50 flex flex-col items-center justify-center text-center w-full max-w-4xl px-4 sm:px-6 gap-6 md:gap-10 mt-2 pb-20 landscape:pb-4 md:pb-32 md:landscape:pb-32 transform-gpu"
        style={{
          transform: `translate3d(0, ${scrollY * -0.03}px, 0)`,
          willChange: "transform",
        }}
      >
        {/* Logo - Proteção Mobile Horizontal: max-h limita tamanho para não empurrar textos pra fora */}
        <div className="w-full max-w-[300px] sm:max-w-[500px] md:max-w-[650px] animate-[forge-reveal_1s_ease-out_forwards] transform-gpu">
          <img
            ...
            decoding="async"
            draggable="false"
            className="w-full h-auto drop-shadow-[0_10px_25px_rgba(255,69,0,0.3)] hover:scale-105 transition-transform duration-700 transform-gpu max-h-[25vh] landscape:max-h-[35vh] md:max-h-none md:landscape:max-h-none object-contain"
          />
        </div>
        ...
        <div className="space-y-4 animate-[forge-reveal_1.5s_ease-out_forwards] px-4 transform-gpu">
          ...
          <div className="flex flex-wrap justify-center items-center text-white font-medieval tracking-[0.25em] text-xs sm:text-sm md:text-lg drop-shadow-[0_2px_8px_rgba(0,0,0,1)] uppercase gap-y-1">
            <span className="whitespace-nowrap">Criatividade</span>
            <span className="text-zinc-500 mx-2 sm:mx-3">|</span>
            <span className="whitespace-nowrap">Inovação</span>
            <span className="text-zinc-500 mx-2 sm:mx-3">|</span>
            <span className="whitespace-nowrap">Tecnologia</span>
          </div>
        </div>

        {/* Botão de Entrar na Forja: Alterado de 'inline-flex' para 'hidden lg:inline-flex' para não aparecer no celular. Design Desktop intacto. */}
      ...
      <div className="absolute bottom-0 left-0 w-full border-t border-zinc-900/50 bg-black/60 backdrop-blur-xl z-50 hidden md:block transform-gpu">
        <div className="max-w-[1200px] mx-auto px-6 py-6 flex justify-between items-center text-center">
          <div className="flex-1 border-r border-zinc-900/60">
            <p className="text-zinc-500 text-[10px] uppercase tracking-[0.3em] font-sans mb-2">Fundação</p>
            <p className="text-xl text-white font-medieval tracking-widest">2011</p>
          </div>

          <div className="flex-1 border-r border-zinc-900/60 relative">
            <p className="text-zinc-500 text-[10px] uppercase tracking-[0.3em] font-sans mb-2">Projeto Destaque</p>
            <p className="text-xl text-ouro-epico font-medieval tracking-wider drop-shadow-[0_0_15px_rgba(212,175,55,0.2)]">Dark Meeting</p>
          </div>

          <div className="flex-1">
            <p className="text-zinc-500 text-[10px] uppercase tracking-[0.3em] font-sans mb-2">Foco</p>
            <p className="text-xl text-zinc-300 font-medieval tracking-wider">Survivor RPG</p>
          </div>
        </div>
      </div>
    </section>
